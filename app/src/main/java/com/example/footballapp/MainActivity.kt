...
import com.example.footballapp.ui.standings.StandingsFragment
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_favorite -> {
                startActivity(Intent(this, Class.forName("com.example.footballapp.favorite.FavoriteActivity")))
            }
        }
